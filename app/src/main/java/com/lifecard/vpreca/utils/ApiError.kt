...
class ApiError {
    companion object {
        ...
        private val AP2113_MobileConfirmSendRequestError = mapOf(
            ...
            "2113101" to "携帯番号の確認依頼回数が上限を超えています。",
            "2113102" to "ブランドスキーム外部認証機関設定情報が存在しません。",
            "2113103" to "オープン化メール定義情報が存在しません。",
            "2113104" to "SMS認証依頼エラーです。",
            "9999903" to "外部認証設定情報が存在しません。",
        ...
        private val AP2114_MobileConfirmRequestError = mapOf(
            ...
            "2114101" to "連絡先確認履歴が存在しません。",
            "2114102" to "確認コードが認証済みです。",
            "2114103" to "確認コードがロック中です。",
            "2114104" to "確認コードがコード有効時間を超えています。",
            "2114105" to "確認コードが不一致です。",
            "9999903" to "外部認証設定情報の閾値情報が取得できません。",
        ...
        private val AP2115_MailConfirmSendReqError = mapOf(
            ...
            "2115101" to "会員情報が存在しません。",
            "2115102" to "会員情報が有効ではありません。",
            "2115103" to "会員情報のメールアドレスが存在しません。",
            "2115104" to "連携されたメールアドレス又は会員番号に紐づくメールアドレスの確認依頼回数が上限を超えています。",
            "9999903" to "外部認証設定情報が存在しません。",
        ...
        private val AP2116_MailConfirmReqError = mapOf(
            ...
            "2116101" to "連絡先確認履歴が存在しません。",
            "2116102" to "確認コードが認証済みです。",
            "2116103" to "確認コードがロック中です。",
            "2116104" to "確認コードがコード有効時間を超えています。",
            "2116105" to "確認コードが不一致です。",
            "9999903" to "外部認証設定情報の閾値情報が存在しません。",
        ...
        private val AP2321_memberTransactionSettlement = mapOf(
            "8101101" to  "入力された認証番号に該当するカード情報が存在しません。",
            "8101102" to  "入力されたカード番号(下4桁)に合致するカード情報が存在しません。",
            "8101103" to  "カード情報が無効です。",
            "8101104" to  "プリカ有効期限が切れています。",
            "8101105" to  "入力されたVCN有効期限と合致するカード情報が存在しません。",
            "8101106" to  "カード情報が存在しません。",//Member transaction settlement: 外部インタフェース定義書(IFBPAP2321_会員取引精算).pdf
        ...
        private val AP8101_certifyCard = mapOf(
            ...
            "8101104" to  "プリカ有効期限が切れています。",
            "8101105" to  "入力されたVCN有効期限と合致するカード情報が存在しません。",
            "8101106" to  "カード情報が存在しません。",
            //end Member transaction settlement
        )

        private val AG1201_sendSMSRequest = mapOf(
            //Member transaction settlement: 外部インタフェース定義書(IFBPAP2321_会員取引精算).pdf
            "1102101" to "会員情報が存在しません。",
            "1102102" to "会員情報が有効ではありません。",
            "2601101" to "会員情報が存在しません。",
            "2601102" to "会員情報が有効ではありません。",
            "2601103" to "会員の認証依頼回数が上限を超えています。",
            "2601104" to "ブランドスキーム外部認証機関設定情報が存在しません。",
            "2601105" to "オープン化メール定義情報が存在しません。",
            "2601106" to "SMS認証依頼エラーです。",
            "2701101" to "会員情報が存在しません。",
            "2701102" to "会員情報が有効ではありません。",
            "2701103" to "会員情報の認証依頼回数が上限を超えています。",
            "2701104" to "ブランドスキーム外部認証機関設定情報が存在しません。",
            "2701105" to "IVR認証登録エラーです。",
            //end Member transaction settlement
        )
...
//            "IssueSumBankReq" to AP2318,//don't have error
            ...
            "CardCertifiNoMemReq" to AP8101_certifyCard,
            "SmsIvrAuthCodeSendReq" to AG1201_sendSMSRequest,
            "SmsIvrAuthReq" to  AG1201_sendSMSRequest
