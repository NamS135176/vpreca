...
class MyTextInputLayoutWhiteBack @JvmOverloads constructor(
    context: Context,
    ...
    var error: String? = null
        set(value) {
            ...
            if (value?.isNotEmpty() == true) {
                ...
                editText?.background =
                    ContextCompat.getDrawable(context, R.drawable.textinput_error_background_gray)
            } else {
                errorText.visibility = View.GONE
                editText?.background =
                    ContextCompat.getDrawable(context, R.drawable.textinput_background_gray)
            }
        }
